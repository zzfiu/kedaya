...
class Main extends Template {
    ...
    async main(p) {
        ...
        // 跑前认证
        await this.curl({
                'url': `https://joypark.jd.com/?activityId=99DZNpaCTAv8f4TuKXr0Ew&channel=icon&sid=c07acedeb4316f9273bfcd3e7fbfdaew`,
                // 'form':``,
                cookie
            }
        )
        await this.curl({
                'url': `https://mapi.m.jd.com/config/display.action?isNewVersion=1&appType=jdlite&_format_=json&activityId=99DZNpaCTAv8f4TuKXr0Ew&channel=icon&sid=c07acedeb4316f9273bfcd3e7fbfdaew`,
                'form': ` `,
                cookie
            }
        )
        await this.curl({
                'url': `https://wq.jd.com/bases/ylmonitor/preArousal?app=jdliteapp&refer=https%3A%2F%2Fjoypark.jd.com%2F%3FactivityId%3D99DZNpaCTAv8f4TuKXr0Ew%26channel%3Dicon%26sid%3Dc07acedeb4316f9273bfcd3e7fbfdaew&type=1&msg=configCenterAjaxPrame%20Exception&t=0.865337744831448`,
                // 'form':``,
                cookie
            }
        )
        ...
        let d = await this.curl({
                'url': `https://api.m.jd.com/?functionId=getStaticResource&body={"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&cthr=1&build=168528&screen=320*568&networkType=4g&d_brand=iPhone&d_model=iPhone8,4&lang=zh_CN&osVersion=11.4&partner=&eid=eidIf0aa8121d5saWrnr3ryoR6qt1FxGRFjFGVq57Vv5jwdgmcxSHUO23TTEORkTW84A92Fijx10j2lZfx228DL%2BPAqTpx3MK1VsIZiVGD2pPczQWVRx`,
                // 'form':``,
                cookie
            }
        )
        ...
        await this.curl({
                'url': `https://api.m.jd.com/?functionId=getStaticResource&body={"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                // 'form':``,
                cookie
            }
        )
        ...
        let reports = setInterval(async function f() {
            ...
            let report = await self.curl({
                    'url': `https://api.m.jd.com/?functionId=gameHeartbeat&body={"businessCode":1,"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                    // 'form':``,
                    cookie
                }
            )
        ...
        if (this.code.length>0) {
            ...
            if (!this.taskId) {
                let list = await this.curl({
                        ...
                        'form': `functionId=apTaskList&body={"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                    }
                )
        ...
        try {
            ...
            if (this.haskey(base, 'data.level') == 30) {
                let joyRestart = await this.algo.curl({
                        'url': `https://api.m.jd.com/`,
                        'form': `functionId=joyRestart&body={"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                        cookie,
                        algo: {
                            type: "main", "version": "3.1", 'appId': '4abce'
                        }
                        ...
                        switch (i.taskType) {
                            ...
                            case 'SHARE_INVITE':
                                ...
                                if (i.taskLimitTimes != i.taskDoTimes) {
                                    let r = await this.algo.curl({
                                            'url': `https://api.m.jd.com/`,
                                            'form': `functionId=apTaskDrawAward&body={"taskType":"${i.taskType}","taskId":${i.id},"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                            cookie
                                        }
                                    )
                            ...
                            case 'SIGN':
                                let s = await this.algo.curl({
                                        'url': `https://api.m.jd.com/`,
                                        'form': `functionId=apDoTask&body={"taskType":"${i.taskType}","taskId":${i.id},"itemId":"${encodeURIComponent(i.taskSourceUrl)}","linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                        cookie
                                    }
                                )
                            ...
                            case 'BROWSE_PRODUCT':
                                let detail = await this.algo.curl({
                                        'url': `https://api.m.jd.com/`,
                                        'form': `functionId=apTaskDetail&body={"taskType":"${i.taskType}","taskId":${i.id},"channel":4,"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                        cookie
                                    }
                                )
                                if (this.haskey(detail, 'data.taskItemList')) {
                                    let s = await this.algo.curl({
                                            'url': `https://api.m.jd.com/`,
                                            'form': `functionId=apDoTask&body={"taskType":"${i.taskType}","taskId":${i.id},"channel":4,"linkId":"99DZNpaCTAv8f4TuKXr0Ew","itemId":"${(detail.data.taskItemList  [j] || detail.data.taskItemList  [0]).itemId}"}&t=${new Date().getTime()}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                            cookie
                                        }
                                    )
                                    let d = await this.algo.curl({
            ...
            if (this.profile.merge) {
                ...
                if (dict["25"] && dict["26"] && dict["27"] && dict["28"] && dict["29"]) {
                    for (let z of Array(2)) {
                        var buy = await this.algo.curl({
                                'url': `https://api.m.jd.com/`,
                                'form': `functionId=joyBuy&body={"level":21,"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                cookie,
                                algo: {
                ...
                if (min<buyLevel) {
                    ...
                    for (let i = min; i<buyLevel; i++) {
                        ...
                        for (let z of Array(2)) {
                            var buy = await this.algo.curl({
                                    'url': `https://api.m.jd.com/`,
                                    'form': `functionId=joyBuy&body={"level":${i},"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                    cookie,
                                    algo: {
                                        type: "main", "version": "3.1", 'appId': 'ffb36'
                                    }
                    ...
                    if (jump != 0) {
                        ...
                        for (let k of Array(1)) {
                            let buy = await this.algo.curl({
                                    'url': `https://api.m.jd.com/`,
                                    'form': `functionId=joyBuy&body={"level":${buyLevel},"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                    cookie,
                                    algo: {
                                        type: "main", "version": "3.1", 'appId': 'ffb36'
                                    }
                            ...
                            for (let k of spl) {
                                if (k.length == 2) {
                                    let merge = await this.algo.curl({
                                            'url': `https://api.m.jd.com/?functionId=joyMergeGet&body={"joyOneId":${k[0]},"joyTwoId":${k[1]},"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                                            cookie,
                                            algo: {
                ...
                for (let i of jl.reverse()) {
                    let move = await this.algo.curl({
                            'url': 'https://api.m.jd.com/',
                            'form': `functionId=joyMove&body={"joyId":${i},"location":${location},"linkId":"99DZNpaCTAv8f4TuKXr0Ew"}&appid=activities_platform&client=ios&clientVersion=11.6.0&build=168528&screen=390*844&networkType=wifi&d_brand=iPhone&d_model=iPhone13,3&lang=zh_CN&osVersion=13.7&partner=&eid=eidIb24b812115s9jUHzkyfNSICH4T313nxTSY1B9QqDr0IUV8vdzISUvNGSXxO%2BeCNY01V69ImKsiy4ptOddRzE0E%2F950ionHyQBWNiEguhXNM%2B%2BD5v`,
                            cookie,
                            algo: {
